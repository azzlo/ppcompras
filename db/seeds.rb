...
Requisition.create!(number: 100001,
                    ...
                    description: "Material de calidad para electricidad y mas",
                    quantity: 2,
                    unit: "Lt",
...
Requisition.create!(number: 100002,
                    create_at: Date.today,
                    item: 10, material: "aaa001",
                    description: "Se requiren gatos gigantes para soportar 5 toneladas",
                    quantity: 2,
                    unit: "Lt",
                    contact_person: "Joaquin Becerro",
                    observations: "We need best quality")
Requisition.create!(number: 100003,
                    create_at: Date.today,
                    item: 10, material: "aaa001",
                    description: "Material de contruccion para cubrir 500mts cuadrados de piso de concreto",
                    quantity: 2,
                    unit: "Lt",
                    contact_person: "Joaquin Becerro",
                    observations: "We need best quality")
Requisition.create!(number: 100004,
                    create_at: Date.today,
                    item: 10, material: "aaa001",
                    description: "10 equipos de computo workstation para ejecutar solidworks 2017",
                    quantity: 2,
                    unit: "Lt",
                    contact_person: "Joaquin Becerro",
                    observations: "We need best quality")
Requisition.create!(number: 100005,
                    create_at: Date.today,
                    item: 10, material: "aaa001",
                    description: "500 licencias de antivirus con proteccion web",
                    quantity: 2,
                    unit: "Lt",
                    contact_person: "Joaquin Becerro",
                    observations: "We need best quality")
Requisition.create!(number: 100006,
                    create_at: Date.today,
                    item: 10, material: "aaa001",
                    description: "Transformador electrico de alta contencion",
                    quantity: 2,
                    unit: "Lt",
                    contact_person: "Joaquin Becerro",
                    observations: "We need best quality")
...
Requisition.create!(number: 100008,
                    create_at: Date.today,
                    item: 10, material: "aaa001",
                    description: "100 toneladas de chatarra metalica para fundir",
                    quantity: 2,
                    unit: "Lt",
                    contact_person: "Joaquin Becerro",
                    observations: "We need best quality")
Requisition.create!(number: 100009,
                    create_at: Date.today,
                    item: 10, material: "aaa001",
                    description: "10 sillas de officina confortables (8 horas de trabajo)",
                    quantity: 2,
                    unit: "Lt",
                    contact_person: "Joaquin Becerro",
                    observations: "We need best quality")
Requisition.create!(number: 100010,
                    create_at: Date.today,
                    item: 10, material: "aaa001",
                    description: "10 toneladas de arena para fundir hierro",
                    quantity: 2,
                    unit: "Lt",
                    contact_person: "Joaquin Becerro",
                    observations: "We need best quality")
